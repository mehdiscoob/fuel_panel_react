...
import {
  cilAlarm,
  cilAssistiveListeningSystem, cilAudio,
  cilBell,
  cilCalculator, cilCart,
  cilChartPie,
  cilCursor,
  cilDescription,
  cilDrop, cilEnvelopeClosed, cilEnvelopeLetter, cilGift, cilHome, cilImage, cilMediaPlay,
  cilNotes,
...
const _nav = [
  ...
  //       component: CNavItem,
  //       name: 'Charts',
  //       to: '/playlog/playlogcharts',
  //     },
  //     {
  //       component: CNavItem,
  //       name: 'Table',
  //       to: '/playlog/playlog-table',
  //     },
  //
  //   ],
  // },
